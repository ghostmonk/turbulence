...
a migration path from the old logger.py module. Once the migration is complete,
this can replace the old logger.py file.

Usage:
    from logger_new import logger, get_component_logger
